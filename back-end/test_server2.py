...
server2.test_print_function()
class TestSql(unittest.TestCase):

    server2.test_print_function()

    def print_function(self):
        self.assertEqual('hello my friend', server2.test_print_function())


    def test_new_user(self):
         server2.add_new_user({'firstName': 'Joel', 'lastName': '2', 'billingAddressStreet': '3', 'primaryNumber': '4', 'secondaryNumber': '5', 'billingAddressCity': '6', 'billingAddressProvince': 'Alberta', 'email': '1@g.com', 'billingAddressCountry': 'Canada', 'billingAddressPostalCode': '9', 'farmName': 'lemon farms', 'farmLocation': '1', 'mailingAddressStreet': '1', 'farmType': 'LiveStock', 'area': 'Southern AB', 'mailingAddressCity': '1', 'mailingAddressProvince': 'Alberta', 'rating': '1', 'mailingAddressCountry': 'Canada', 'mailingAddressPostalCode': '1', 'comments': '1', 'isAdmin': False, 'isProducer': True, 'isOther': False})
