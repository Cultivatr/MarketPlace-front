...
class TestSql(unittest.TestCase):
    ...
    def test_offered_items_livestock(self):
        ...
        sql.add_livestock_item_by_user_id("1","Beef", "Angus","True","2019-03-01","12345", "678", "500","600","1","Calgary","2019-02-01","Grass", "Alfa", "Barley", "2019-03-05","600","800","1","1000","2019-04-05","Hellllooooo","Pending Approval")
        sql.add_livestock_item_by_user_id("1","Beef", "Birkshire","True","2019-03-02","12345", "678", "500","600","1","Calgary","2019-02-01","Grass", "Alfa", "Barley", "2019-03-05","600","800","1","1000","2019-04-05","Hellllooooo","Pending Approval")
        sql.add_user("Larry", "Lemi", "123-456-7890", "890-123-4567", "test2@gmail.com", "jeff's farm", "calgary", "southern alberta", "TRUE", "TRUE", "TRUE", "2018-09-01", "livestock", "5", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "hellllooooo")
        sql.add_livestock_item_by_user_id("2","Chicken", "Birkshire","True","2019-03-02","12345", "678", "500","600","1","Calgary","2019-02-01","Grass", "Alfa", "Barley", "2019-03-05","600","800","1","1000","2019-04-05","Hellllooooo","Sold")
