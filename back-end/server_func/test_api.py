import unittest
# from offered_items import *
import offered_items
import datetime
import psycopg2
...
class TestApiCalls(unittest.TestCase):
   ...
   def test_offered_item(self):
      self.assertEqual(2, len(offered_items.get_all_offered_items_by_user_id(1)))
      self.assertEqual(6, len(offered_items.get_all_offered_items_by_user_id(2)))
   ...
   #    chargebacks = "null"
   #    offered_items.add_offered_item_by_user_id(name, user_id, qty, est_birthday, registration_number,rfid_tag, breed, single_brand,\
   ...
   #    # test_product_id = offered_items.add_offered_item_by_user_id("name")
   #    self.assertEqual({'product_id':'', 'est_birthdate':'', 'single_brand':'', "user_id":''}, offered_items.get_all_offered_items_by_user_id(1)[-1])
