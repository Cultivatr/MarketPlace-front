...
class TestApiCalls(unittest.TestCase):
   ...
   def test_offered_item(self):
      self.assertEqual(2, len(offered_item.get_all_offered_items_by_user_id(1)))
      self.assertEqual(6, len(offered_item.get_all_offered_items_by_user_id(2)))
   ...
   #    chargebacks = "null"
   #    offered_item.add_offered_item_by_user_id(name, user_id, qty, est_birthday, registration_number,rfid_tag, breed, single_brand,\
