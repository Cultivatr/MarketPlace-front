          ...
          <div className="ui grid container">
            <form onSubmit={this.onSubmit} className="ui row form">
              <div className="form-column-8">
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Package Type </label><Tooltip message={'Hello This Is Package Type'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <select
                    onChange={this.onChange}
                    name="packageType"
                    multiple=""
                ...
                <div className="field size-container">
                  <div><label style={{fontWeight:"bolder"}}>Package Size </label><Tooltip message={'Hello This Is Package Size'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Est Completion Date </label><Tooltip message={'Hello This Is Est Completion Date'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <div
                    className="dpicker"
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Seed Type </label><Tooltip message={'Hello This Is Seed Type'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <input onChange={this.onChange} type="text" name="seedType" />
                </div>
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Modified Seed </label><Tooltip message={'Hello This Is Modified Seed'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <select
                    onChange={this.onChange}
                    name="modifiedSeed"
                    multiple=""
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Heirloom </label><Tooltip message={'Hello This Is Heirloom'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <select
                    onChange={this.onChange}
                    name="heirloom"
                    multiple=""
              ...
              <div className="form-column-8">
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Estimated Quantity Planted </label><Tooltip message={'Hello This Is Est Quanity Planted'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <input
                    onChange={this.onChange}
                    type="number"
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Certified Organic </label><Tooltip message={'Hello This Is Cert. Organic'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <select
                    onChange={this.onChange}
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Estimated Finished Qty </label><Tooltip message={'Hello This Is Est Finished Quanity'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <input
                    onChange={this.onChange}
                    type="number"
                    name="estFinishedQty"
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Fertilizer Type Used </label><Tooltip message={'Hello This Is Fertilizer Type Used'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <input
                    onChange={this.onChange}
                    type="text"
                ...
                <div className="field">
                  <div><label style={{fontWeight:"bolder"}}>Pesticide Type Used </label><Tooltip message={'Hello This Is Pesticide Type Used'} position={'top'}><img alt="" style={{ width: "15px", height: "15px" }} src={i}></img></Tooltip></div>
                  <input
                    onChange={this.onChange}
                    type="text"
