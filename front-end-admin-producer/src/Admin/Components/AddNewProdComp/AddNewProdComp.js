...
class AddNewProdComp extends Component {
  ...
  onSubmit = e => {
    ...
    if (
      ...
      // temp.firstName &&
      // temp.lastName &&
      // temp.billingAddressStreet &&
      // temp.primaryNumber &&
      // temp.secondaryNumber &&
      // temp.billingAddressCity &&
      // temp.email &&
      // temp.billingAddressCountry &&
      // temp.billingAddressPostalCode &&
      // temp.farmName &&
      // temp.farmLocation &&
      // temp.mailingAddressStreet &&
      // temp.mailingAddressCity &&
      // temp.mailingAddressCountry &&
      // temp.mailingAddressPostalCode
    ) {
    ...
    } else console.log("You are missing a field!");
  };
      ...
      <div className="ui grid">
        <form onSubmit={this.onSubmit} className="ui row form">
          ...
          <div className={Class.buttonContainer}>
            ...
            <div className={Class.addNewProdButton}>
              <button onClick={this.state.clearButton} className="ui button">
                Clear Fields
              </button>
            </div>
          </div>
